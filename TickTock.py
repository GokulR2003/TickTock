...
canvas = tk.Canvas(app_window, width=500, height=500)
canvas.pack()
canvas.create_image(0, 0, anchor=tk.NW, image=bg_photo)
center_x, center_y = 250, 250
radius = 200
canvas.create_oval(center_x - radius, center_y - radius, center_x + radius, center_y + radius, fill="", outline="#282c34", width=4)
for i in range(12):
...
label_time = tk.Label(app_window, font=time_font, bg="", fg=hand_color)
label_date = tk.Label(app_window, font=date_font, bg="", fg=hand_color)
